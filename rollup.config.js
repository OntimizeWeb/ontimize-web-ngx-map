...
export default {
  ...
  plugins: [
    ...
    commonjs({
      namedExports: {
        ...
        'node_modules/leaflet/dist/leaflet-src.js': ['tileLayer', 'TileLayer', 'Icon', 'LatLng', 'control', 'marker', 'point', 'DomUtil', 'DomEvent', 'Map', 'icon', 'LatLngBounds', 'ImageOverlay', 'Polyline', 'Polygon', 'Rectangle', 'Circle', 'layerGroup', 'featureGroup', 'geoJSON', 'Util', 'FeatureGroup', 'Control', 'Proj', 'CRS']
      },
  ...
  output: {
    format: 'umd',
    name: 'ng.ontimizeWebMap',
    globals: globals,
    sourcemap: true,
    exports: 'named',
    amd: { id: 'ontimize-web-ngx-map' }
  }
}
