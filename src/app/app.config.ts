...
export const CONFIG: Config = {
  ...
  uuid: 'com.ontimize.web.ng2.map.quickstart',
  ...
  // The service type used (Ontimize REST standart,
  // Ontimize REST JEE or custom implementation) in the whole application.
